...
export default function MembersPage() {
    ...
    const fetchEmployees = useCallback(async () => {
        if (loading || !isLoggedIn || dataLoading) {
            return;
        }
        setDataLoading(true);
        try {
    ...
    }, [loading, isLoggedIn, dataLoading, orgStructure.length, orgLoading, fetchOrganizationStructure]);
    ...
    }, [loading, isLoggedIn, fetchEmployees]);
