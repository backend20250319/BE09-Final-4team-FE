...
export default function OrganizationSettingsModal({
  ...
  const handleOrgSave = (org: Organization) => {
    ...
    const insertUnderParent = (
      ...
      return orgs.map((o) => {
        ...
        if (o.children && o.children.length > 0) {
          return {
            ...o,
            children: insertUnderParent(o.children, parentId, node),
          };
        }
        return o;
      });
    ...
    if (editingOrg) {
      const parentChanged =
        (editingOrg.parentId || "") !== (org.parentId || "");
      if (parentChanged) {
  ...
  const handleOrgDelete = (id: string) => {
    const remove = (orgs: Organization[]): Organization[] =>
      orgs
        ...
        .map((o) => ({
          ...o,
          children: o.children ? remove(o.children) : o.children,
        }));
  ...
  const isAllExpanded =
    allOrgIds.size > 0 && expandedOrgs.size >= allOrgIds.size;
