...
export default function AddOrganizationModal({
    ...
    const [mainOrgWarningMembers, setMainOrgWarningMembers] = useState<SelectedMember[]>([]);
    ...
    useEffect(() => {
        const initial = organization
            ? {
                ...
                memberIds: (organization.members || []).map((m) => m.member.id).join(","),
            }
                ...
                >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                {selectedLeader
                                    ? `${selectedLeader.member.name} ${selectedLeader.member.role} (${selectedLeader.assignmentType === "main" ? "메인" : "겸직"})`
                                    : "조직장 선택"}
                            </Button>
                            {selectedLeader && (
                                <div className="flex flex-wrap gap-2 mt-2">
                                    <Badge
                                        ...
                                        className={`cursor-pointer hover:bg-red-100 ${
                                            selectedLeader.assignmentType === "main" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"
                                        }`}
                                ...
                                <div className="flex flex-wrap gap-2 mt-2">
                                    {selectedMembers.map((item) => (
                                        <Badge
                                            ...
                                            variant="secondary"
                                            className={`cursor-pointer hover:bg-red-100 ${
                                                item.assignmentType === "main" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"
                                            }`}
