             ...
             <GlassCard className="p-6">
               ...
               <div className="space-y-3">
                 {approval.approvalStages.map((stage: any, stageIndex: number) => (
                   <div key={stageIndex} className="border border-gray-200 rounded-lg">
                     <div 
                         ...
                         <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                           ...
                           {stage.status === "completed" ? (
                             ...
                             <X className="w-4 h-4 text-gray-600" />
                                                   ...
                                                   <div>
                            <p className="font-medium text-gray-800">{stageIndex + 1}단계 승인</p>
                            <p className="text-sm text-gray-500">
                              {stage.status === "completed" ? "완료" :
                               stage.status === "current" ? "진행중" :
                               stage.status === "pending" ? "대기중" : "취소됨"}
                            </p>
                          </div>
                       </div>
                       <div className="flex items-center gap-2">
                           ...
                           <div key={approverIndex} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                             <div className="flex items-center gap-3">
                               <div className={`w-6 h-6 rounded-full flex items-center justify-center ${
                                 approver.status === "completed" ? "bg-green-100" :
                                 approver.status === "pending" ? "bg-yellow-100" :
                                 "bg-red-100"
                               }`}>
                             ...
                             <div className="text-right">
                               ...
                               {approver.comment && (
                                 <p className="text-xs text-gray-600 mt-1">{approver.comment}</p>
                               )}
                             </div>
                           </div>
                         ))}
