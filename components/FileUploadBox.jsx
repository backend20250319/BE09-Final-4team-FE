...
export default function FileUploadBox({ attachment, onFileChange, onRemoveFile }) {
      ...
      {!attachment ? (
        ...
        <div className="relative w-fit">
          <div className="flex items-center gap-2 p-4 border rounded bg-gray-50 w-fit pr-10">
            ...
            <span className="text-xs text-gray-400 ml-2">{(attachment.size / 1024).toFixed(1)}KB</span>
          </div>
          <button
            type="button"
