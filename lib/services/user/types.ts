...
export interface ApiResultUserResponseDto {
  status: string;
  message: string;
  data: UserResponseDto;
}

export interface ApiResultListUserResponseDto {
  status: string;
  message: string;
  data: UserResponseDto[];
}

export interface ApiResultTokenResponseDto {
  status: string;
  message: string;
  data: TokenResponseDto;
}

export interface ApiResultMainProfileResponseDto {
  status: string;
  message: string;
  data: MainProfileResponseDto;
}

export interface ApiResultDetailProfileResponseDto {
  status: string;
  message: string;
  data: DetailProfileResponseDto;
}

export interface ApiResultListColleagueResponseDto {
  status: string;
  message: string;
  data: ColleagueResponseDto[];
}
